...
#### Методы, возвращающие логические значения — это прилагательные
...
* **Оборонительная стратегия**. Проверка аргумента на NULL и выброс
исключения.
```java
public Iterable<File> find(Mask mask) {
    if (mask == null) {
        throw new IllegalArgumentException("Маска не м.б. NULL");
    }
