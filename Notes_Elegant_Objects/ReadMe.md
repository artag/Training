...
#### Альтернативы NULL (3 подхода)

1. Отказывать как можно скорее (поход скорейшего отказа)

  * Остановить выполнение и выбросить исключение, как только мы столкнемся
с проблемой (любой!)
...
Метод называется `user()`, но возвращает "конверт" с пользователем.
...
#### Восстанавливайтесь единожды и только на верхнем уровне
