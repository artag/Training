...
```text
Main thread: Go. Enter lock
Main thread: GoInternal. Enter lock
Main thread: GoInternal. Exit lock
Main thread: Go. Exit lock
Thread: Go. Enter lock
Thread: GoInternal. Enter lock
Thread: GoInternal. Exit lock
Thread: Go. Exit lock
End. Result = 100
```
