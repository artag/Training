...
Функция должна делать только одну вещь (thing) и делать ее хорошо.
...
Функция должна делать только одну вещь (thing) и делать ее хорошо. Но что такое это за одна вещь?

* Если функция состоит из нескольких секций, она определенно делает несколько вещей (things).

* Если функция обращается к разным уровням абстракции, она определенно делает несколько вещей
...
3. Функции должны делать только одну вещь (thing).
...
* Функция, которая принимает 2 boolean параметра, делает 4 things. Более того, в каком порядке
