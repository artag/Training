...
let main _ =
    ...
    printfn "Opening balance is $%M" (openingAccount.GetField(fun f -> f.Balance))
        ...
        let account =
            ...
            | Withdraw ->
                ...
                | Overdrawn _ ->
                    ...
                    account
        printfn "Current balance is $%M" (account.GetField(fun f -> f.Balance))
        match account with
        | InCredit _ -> ()
    ...
    printfn ""
    printfn "Closing Balance: $%M" (closingAccount.GetField(fun f -> f.Balance))
