...
Interestingly, in F#, the call to the class constructor - `StringComparisons logger` - looks
...
Next, we need a way to map from the `Services` type to the individual sub-environments.
