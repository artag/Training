...
using Clean.Architecture.Entities.ProjectAggregate.Events;
using MediatR;

namespace Clean.Architecture.Entities.ProjectAggregate;

public class Project : EntityBase, IAggregateRoot, IRequest<Unit>
{
