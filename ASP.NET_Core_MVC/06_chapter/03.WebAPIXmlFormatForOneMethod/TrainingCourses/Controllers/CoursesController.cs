...
public class CoursesController : ControllerBase
{
    ...
    // GET api/courses
    // (1) Устанавливат содержимое возвращаемого ответа в формат XML
    // Для остальных методов формат ответа остается прежним - JSON
    [HttpGet]
    [Produces(MediaTypeNames.Application.Xml)]      // (1)
