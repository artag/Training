...
public class CoursesController : Controller
{
    ...
    {
        // Имитация задержки получения данных. В реальных проектах так делать не надо!
        Thread.Sleep(3000);
    ...
    public IActionResult Put(int id, [FromBody] Course newCourse)
    {
        ...
        // Возвращаем JSON чтобы AJAX распознал ответ и
        // можно было посмотреть результат выполнения в консоли браузера.
        return Json(true);
    }
